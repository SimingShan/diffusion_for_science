...
diffusion.load_state_dict(torch.load('/home/wangpengkai/node/self_diffusion_learn/models/turbulent/model-10.pt', map_location='cuda:1')['model'])
...
plt.savefig("ddpm_combined_turbulent_100.png", bbox_inches='tight', dpi=400)